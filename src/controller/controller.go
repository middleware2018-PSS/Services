...
//TODO REMOVE THIS package AND REMOVE SWITCHING errors or handle them at presentation level
...
func (con *Controller) TeacherByID(id int64) (interface{}, error) {
...
func (con *Controller) NotificationByID(id int64) (interface{}, error) {
	return getByID(id, con.r.NotificationByID)
}

func (con *Controller) ParentByID(id int64) (interface{}, error) {
	return getByID(id, con.r.ParentByID)
}

func (con *Controller) StudentByID(id int64) (interface{}, error) {
...
func (con *Controller) SubjectsByTeacher(id int64, limit int, offset int) ([]interface{}, error) {
...
func (con *Controller) ChildrenByParent(id int64, limit int, offset int) ([]interface{}, error) {
...
func (con *Controller) AppointmentsByParent(id int64, limit int, offset int) ([]interface{}, error) {
	return getListByIDOffsetLimit(id, limit, offset, con.r.AppointmentsByParent)
}

func (con *Controller) PaymentsByParent(id int64, limit int, offset int) ([]interface{}, error) {
	return getListByIDOffsetLimit(id, limit, offset, con.r.PaymentsByParent)
}

func (con *Controller) NotificationsByParent(id int64, limit int, offset int) ([]interface{}, error) {
	return getListByIDOffsetLimit(id, limit, offset, con.r.NotificationsByParent)
}

func (con *Controller) ClassesByTeacher(id int64, limit int, offset int) ([]interface{}, error) {
	return getListByIDOffsetLimit(id, limit, offset, con.r.ClassesByTeacher)
}

func (con *Controller) StudentsByClass(id int64, limit int, offset int) ([]interface{}, error) {
	return getListByIDOffsetLimit(id, limit, offset, con.r.StudentsByClass)
}

func (con *Controller) PaymentByID(id int64) (interface{}, error) {
	return getByID(id, con.r.PaymentByID)
}

func (con *Controller) UpdateParent(parent models.Parent) error {
	return con.r.UpdateParent(parent)
}

func (con *Controller) UpdateStudent(student models.Student) error {
	return con.r.UpdateStudent(student)
}

func (con *Controller) UpdateTeacher(teacher models.Teacher) error {
	return con.r.UpdateTeacher(teacher)
}
